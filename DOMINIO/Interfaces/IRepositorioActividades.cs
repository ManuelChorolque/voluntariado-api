...
namespace DOMINIO.Interfaces
{
    ...
    {
        Task<IEnumerable<Actividad>> ObtenerTodosAsync(int pageNumber = 1, int pageSize = 10, int? organizacionId = null, string? busquedaNombre = null);
        Task<Actividad?> ObtenerPorIdAsync(int id);
        Task<IEnumerable<Actividad>> ObtenerPorOrganizacionAsync(int organizacionId);
        Task<IEnumerable<Actividad>> ObtenerActividadesAbiertasAsync();
